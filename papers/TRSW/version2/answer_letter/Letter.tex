...
\begin{enumerate}
	...
	%
	However, we added a proof in the manuscript in which we stablish well-posedness of the linear systems (and hence of the resulting numerical methods), see Theorem 3.2. 
