...
\begin{frame}
	\frametitle{Shock detection}
		...
		We identify: Smooth (S), Rough no contact (RNC), Rough contact (RC)
		
		\begin{itemize}
			\item RNC: $\varepsilon^{\rho u}_i>A \overline{\varepsilon}^{\rho u}$ and $\varepsilon^{p}_i>B \overline{\varepsilon}^{p}$
			\item RC: $\varepsilon^{\rho u}_i>A \overline{\varepsilon}^{\rho u}$ and $\varepsilon^{p}_i \leq B \overline{\varepsilon}^{p}$
			\item S: otherwise
		\end{itemize}
