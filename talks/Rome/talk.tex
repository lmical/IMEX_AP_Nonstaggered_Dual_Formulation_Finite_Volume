...
\begin{frame}
	\frametitle{Importance of conservation at the discrete level\footnote{{\tiny P. Lax, B. Wendroff, Systems of conservation laws, Technical report, LANL, 1958.}}}
		...
		All schemes \textbf{MUST} satisfy conservation.\\

%		\begin{block}{Lax-Wendroff Theorem\footnote{{\tiny P. Lax, B. Wendroff, Systems of conservation laws, Technical report, LANL, 1958.}}
%			
%		\end{block}
	
		\begin{block}{Lax-Wendroff Theorem}
			{\footnotesize If a conservative numerical scheme converges, then it converges towards a weak solution.}
		\end{block}

		\begin{block}{Definition: Weak Solution}
			$u\in L^{\infty}(\Omega \times \mathbb{R}^+_0)$ s.t.
		\end{block}
