...
# File paths
folder = f"/home/lorenzo/Dropbox/Lorenzo/Git_ActiveFlux/Codes/code_conservative_Euler_2D/IMEX_HYPERBOLIC_TRICK_RHO_P_STAR_STAGE_DEPENDENT/baroclinic_vorticity_generation/eps0.05/space_reconstruction27/time_scheme_"+str(time_scheme)+"/K0.0/CFL"+str(CFL)+"/"
...
cbar_ro = fig.colorbar(cont_ro, ax=ax_ro, shrink=0.5)
