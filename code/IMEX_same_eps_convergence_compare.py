...
epsilon=0.001 #1.0 #0.1 #0.01 #0.001

name_base_folder    ="IMEX_standard_hyperbolicity_trick_modified" #"IMEX_non_replacing_primitive_variables" #"IMEX_standard","IMEX_standard_hyperbolicity_trick_modified"
CFL                 =0.25
ord=2
if ord==1:
...
teststocompare=[] 
teststocompare.append([name_base_folder,nametest,space_reconstruction,time_scheme,str(0.0)  ,epsilon, CFL]) 
teststocompare.append([name_base_folder,nametest,space_reconstruction,time_scheme,str(1.0)  ,epsilon, CFL]) 
teststocompare.append([name_base_folder,nametest,space_reconstruction,time_scheme,str(2.0)  ,epsilon, CFL]) 
teststocompare.append([name_base_folder,nametest,space_reconstruction,time_scheme,str(5.0)  ,epsilon, CFL]) 
teststocompare.append([name_base_folder,nametest,space_reconstruction,time_scheme,str(10.0) ,epsilon, CFL]) 
...
plt.savefig("convergence_same_epsilon_"+name_base_folder+"_"+nametest+"_eps"+str(epsilon)+"_order"+str(ord)+".pdf", format="pdf", bbox_inches="tight")
