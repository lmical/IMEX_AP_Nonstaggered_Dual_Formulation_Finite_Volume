...
# numbertest=4
# # # # # SAFE # # # # nametest="advection_velocity_multifluid"
# # # # # SAFE # # # # nametest="advection_velocity"
# # nametest="advection_momentum_multifluid"
# nametest="advection_momentum"
# space_reconstructions =[-23] #-np.array([-1, -20, -21, -22, -23, -24]) #put sign -
# time_schemes         =[3]
# post_processings     =[1]
# N_refinements = {1:6,2:6,20:6,21:6,22:6,23:6,24:6,25:6,26:6,-1:6,-2:6,-20:6,-21:6,-22:6,-23:6,-24:6,-25:6,-26:6}
# starting_elements_X=50
...
# numbertest=-4
# # # # # SAFE # # # # nametest="advection_velocity_multifluid_longer_time"
# # # # # SAFE # # # # nametest="advection_velocity_longer_time"
# # nametest="advection_momentum_multifluid_longer_time"
# nametest="advection_momentum_longer_time"
# space_reconstructions =[-23] #-np.array([-1, -20, -21, -22, -23, -24]) #put sign -
# time_schemes         =[3]
# post_processings     =[1]
# # N_refinements = {1:6,2:6,20:6,21:6,22:6,23:6,24:6,25:6,26:6,-1:6,-2:6,-20:6,-21:6,-22:6,-23:6,-24:6,-25:6,-26:6}
# # starting_elements_X=50
# N_refinements = {1:1,2:1,20:1,21:1,22:1,23:1,24:1,25:1,26:1,-1:1,-2:1,-20:1,-21:1,-22:1,-23:1,-24:1,-25:1,-26:1}
# starting_elements_X=100
# starting_elements_X_dict = {key: starting_elements_X for key in space_reconstructions}  # use elements of 'orders' as keys
# test_type="2D" #"1D" #"2D" #Depending on this I will modify or not the elements in the Y direction
# starting_elements_Y=starting_elements_X
# starting_elements_Y_dict = {key: starting_elements_Y for key in space_reconstructions}  # use elements of 'orders' as keys
...
# numbertest=5
# # # # # # SAFE # # # # nametest="advection_x_velocity_multifluid"
# # # # # # SAFE # # # # nametest="advection_x_velocity"
# # nametest="advection_x_momentum_multifluid"
# nametest="advection_x_momentum"
# space_reconstructions =[-23] #-np.array([-1, -20, -21, -22, -23, -24]) #put sign -
# time_schemes         =[3]
# post_processings     =[0]
# N_refinements = {1:6,2:6,20:6,21:6,22:6,23:6,24:6,25:6,26:6,-1:6,-2:6,-20:6,-21:6,-22:6,-23:6,-24:6,-25:6,-26:6}
...
# numbertest=6
# # # # # # # SAFE # # # # nametest="advection_y_velocity_multifluid"
# # # # # # # SAFE # # # # nametest="advection_y_velocity"
# # nametest="advection_y_momentum_multifluid"
# nametest="advection_y_momentum"
# space_reconstructions =[-23] #-np.array([-1, -20, -21, -22, -23, -24]) #put sign -
# time_schemes         =[3]
# post_processings     =[0]
# N_refinements = {1:6,2:6,20:6,21:6,22:6,23:6,24:6,25:6,26:6,-1:6,-2:6,-20:6,-21:6,-22:6,-23:6,-24:6,-25:6,-26:6}
...
# starting_elements_Y_dict = {key: starting_elements_Y for key in space_reconstructions}  # use elements of 'orders' as keys
# speed_estimate=0
# CFL=0.01 #LAST MINMOD NOT WORKING HERE THOUGH
...
# starting_elements_Y_dict = {key: starting_elements_Y for key in space_reconstructions}  # use elements of 'orders' as keys
# speed_estimate=0
# CFL=0.95 #NOT WORKING EVEN FOR VERY LOW CFL
...
name_base_folder="singlefluid_tests"
    ...
    for time_scheme in time_schemes:
        for post_processing in post_processings:
            ...
            for indi,element_X in enumerate(elements_X):        
                if test_type=="2D":
                    instruction+="./main "+str(numbertest)+" "+str(int(element_X))+" "+str(int(elements_Y[indi]))+" "+str(space_reconstruction)+" "+str(time_scheme)+" "+str(CFL)+" "+str(post_processing)+" "+" \n" 
                elif test_type=="1D":
                    instruction+="./main "+str(numbertest)+" "+str(int(element_X))+" "+str(int(elements_Y[0]))+" "+str(space_reconstruction)+" "+str(time_scheme)+" "+str(CFL)+" "+str(post_processing)+" "+" \n" 
                else:
