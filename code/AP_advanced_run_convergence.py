...
name_base_folder="new_formulation_pressure"
    ...
    for time_scheme in time_schemes:
        for post_processing in post_processings:
            for epsilon in epsilons:
                foldName=name_base_folder+"/"+nametest+"/eps"+str(epsilon)+"/space_reconstruction"+str(space_reconstruction)+"/time_scheme_"+str(time_scheme)+"/PP"+str(post_processing)+"/CFL"+str(CFL)
                instruction =""
