...
# File paths
folder = f"/home/lorenzo/Dropbox/Lorenzo/Git_ActiveFlux/Codes/code_conservative_Euler_2D/IMEX_HYPERBOLIC_TRICK_RHO_P_STAR_STAGE_DEPENDENT/double_shear_layer_256/eps"+str(eps)+"/space_reconstruction27/time_scheme_"+str(time_scheme)+"/K0.0/CFL"+str(CFL)+"/"
