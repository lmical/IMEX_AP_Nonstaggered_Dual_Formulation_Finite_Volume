!===============================================================================!
MODULE MOD_IterativeLinearSolver
!===============================================================================!
IMPLICIT NONE
!-------------------------------------------------------------------------------!
PRIVATE
!-------------------------------------------------------------------------------!
INTERFACE pmgmres_ilu_cr
MODULE PROCEDURE pmgmres_ilu_cr
END INTERFACE
INTERFACE mgmres_st
  MODULE PROCEDURE mgmres_st
END INTERFACE
!-------------------------------------------------------------------------------!
PUBLIC :: mgmres_st, pmgmres_ilu_cr
!-------------------------------------------------------------------------------!
!
!
!
...
!
!    integer IA(N+1), JA(NZ_NUM), the row and column
...
!  Output:
!
!    real ( kind = rk ) W(N), the value of A'*X.
!
  implicit none
...
!
!  Handle the case where the update is too small to make a difference.
!
...
!
  ...
  IF (rho > rho_tol .or. rho > tol_abs ) THEN
    PRINT*, "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"
    PRINT*, 'The iterative linear solver did not converge'
    PRINT*, "Iterations", itr_used
    PRINT*, "Absolute tolerance", rho_tol, tol_abs
...
!
!===============================================================================!
END MODULE MOD_IterativeLinearSolver
!-------------------------------------------------------------------------------!
