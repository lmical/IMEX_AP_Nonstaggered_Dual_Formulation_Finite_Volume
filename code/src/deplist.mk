equation.o: equation.f90 \
	finitevolume_vars.o \
	reconstruction.o \
	exact_riemann_solver.o \
	multifluid_riemann_solver.o

exact_riemann_solver.o: exact_riemann_solver.f90 

multifluid_riemann_solver.o: multifluid_riemann_solver.f90 

finitevolume_vars.o: finitevolume_vars.f90

jacobi_iteration.o: jacobi_iteration.f90

iterativelinearsolver.o: iterativelinearsolver.f90

lsqrblas.o:  lsqrblas.f90 
...
direct_linear_solver.o:  direct_linear_solver.f90 
...
finitevolume.o: finitevolume.f90 \
	...
	mesh.o \
	jacobi_iteration.o \
	iterativelinearsolver.o \
	lsqr.o \
	algebra.o \
	direct_linear_solver.o
