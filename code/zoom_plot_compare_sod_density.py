...
fig_density, ax_density = pl.subplots(1)
...
axins1_density = inset_axes(ax_density, width="80%", height="80%", loc='upper right', bbox_to_anchor=(-0.4, 0.48, 0.4, 0.4), bbox_transform=fig_density.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.2, 0.3, 0.9, 1.01  # Specify the limits of the zoomed-in area
axins1_density.set_xlim(x1, x2)
axins1_density.set_ylim(y1, y2)
axins1_density.set_title("A",fontsize=fs)
# Add a rectangle to highlight the zoomed area in the main plot
ax_density.indicate_inset_zoom(axins1_density, edgecolor="black")
mark_inset(ax_density, axins1_density, loc1=2, loc2=4, fc="none", ec="0.5")

# Create an inset axes object with specific dimensions and position it outside the main plot area
axins2_density = inset_axes(ax_density, width="80%", height="80%", loc='upper right', bbox_to_anchor=(-0.4, 0.05, 0.4, 0.4), bbox_transform=fig_density.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.45, 0.55, 0.37, 0.5  # Specify the limits of the zoomed-in area
axins2_density.set_xlim(x1, x2)
axins2_density.set_ylim(y1, y2)
axins2_density.set_title("B",fontsize=fs)
# Add a rectangle to highlight the zoomed area in the main plot
ax_density.indicate_inset_zoom(axins2_density, edgecolor="black")
mark_inset(ax_density, axins2_density, loc1=2, loc2=4, fc="none", ec="0.5")

# Create an inset axes object with specific dimensions and position it outside the main plot area
axins3_density = inset_axes(ax_density, width="80%", height="80%", loc='upper right', bbox_to_anchor=(0.95, 0.05, 0.4, 0.4), bbox_transform=fig_density.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.83, 0.87, 0.1, 0.3  # Specify the limits of the zoomed-in area
axins3_density.set_xlim(x1, x2)
axins3_density.set_ylim(y1, y2)
axins3_density.set_title("C",fontsize=fs)
# Add a rectangle to highlight the zoomed area in the main plot
ax_density.indicate_inset_zoom(axins3_density, edgecolor="black")
mark_inset(ax_density, axins3_density, loc1=2, loc2=4, fc="none", ec="0.5")


# Create an inset axes object with specific dimensions and position it outside the main plot area
axins4_density = inset_axes(ax_density, width="80%", height="80%", loc='upper right', bbox_to_anchor=(0.95, 0.48, 0.4, 0.4), bbox_transform=fig_density.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.6, 0.74, 0.24, 0.45  # Specify the limits of the zoomed-in area
axins4_density.set_xlim(x1, x2)
axins4_density.set_ylim(y1, y2)
axins4_density.set_title("D",fontsize=fs)
# Add a rectangle to highlight the zoomed area in the main plot
ax_density.indicate_inset_zoom(axins4_density, edgecolor="black")
mark_inset(ax_density, axins4_density, loc1=2, loc2=4, fc="none", ec="0.5")
...
if os.path.isdir(solfoldName):  #CONDITION: Is it a folder? If yes go on
    ...
    if os.path.isfile(namefile): #If the file exists, read it
        ...
        ax_density.plot(x_ref,ro_ref,linestyle="-",linewidth=lwex,label=solution_type,color="k")
        ...
        axins1_density.plot(x_ref,ro_ref,linestyle="-",linewidth=lwex,label=solution_type,color="k")
        axins2_density.plot(x_ref,ro_ref,linestyle="-",linewidth=lwex,label=solution_type,color="k")
        axins3_density.plot(x_ref,ro_ref,linestyle="-",linewidth=lwex,label=solution_type,color="k")
        axins4_density.plot(x_ref,ro_ref,linestyle="-",linewidth=lwex,label=solution_type,color="k")
        ...
        if os.path.isfile(namefile): #If the file exists, read it
            ...
            if os.path.isfile(foldName+"/"+ filename):
                ...
                if os.path.isfile(foldName+"/"+ file):
                    ...
                    ax_density.plot(z,RO,marker=markers_space_reconstruction[space_reconstruction],linestyle=linestyles_space_reconstruction[space_reconstruction],linewidth=lw, markersize=ms,label=label_space_reconstruction[space_reconstruction]+" "+label_time_scheme[time_scheme],color=colors[space_reconstruction],alpha=0.7,zorder=3)
                    index_plot=index_plot+1

                    # Plot the same data on the inset axes
                    axins1_density.plot(z,RO,marker=markers_space_reconstruction[space_reconstruction],linestyle=linestyles_space_reconstruction[space_reconstruction],linewidth=lw, markersize=ms,label=label_space_reconstruction[space_reconstruction]+" "+label_time_scheme[time_scheme],color=colors[space_reconstruction],alpha=0.7,zorder=3)
                    axins2_density.plot(z,RO,marker=markers_space_reconstruction[space_reconstruction],linestyle=linestyles_space_reconstruction[space_reconstruction],linewidth=lw, markersize=ms,label=label_space_reconstruction[space_reconstruction]+" "+label_time_scheme[time_scheme],color=colors[space_reconstruction],alpha=0.7,zorder=3)
                    axins3_density.plot(z,RO,marker=markers_space_reconstruction[space_reconstruction],linestyle=linestyles_space_reconstruction[space_reconstruction],linewidth=lw, markersize=ms,label=label_space_reconstruction[space_reconstruction]+" "+label_time_scheme[time_scheme],color=colors[space_reconstruction],alpha=0.7,zorder=3)
                    axins4_density.plot(z,RO,marker=markers_space_reconstruction[space_reconstruction],linestyle=linestyles_space_reconstruction[space_reconstruction],linewidth=lw, markersize=ms,label=label_space_reconstruction[space_reconstruction]+" "+label_time_scheme[time_scheme],color=colors[space_reconstruction],alpha=0.7,zorder=3)
