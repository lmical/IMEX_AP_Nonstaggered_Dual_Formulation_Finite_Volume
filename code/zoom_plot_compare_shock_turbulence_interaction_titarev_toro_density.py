...
axins1_density = inset_axes(ax_density, width="100%", height="180%", loc='upper right', bbox_to_anchor=(-0.4, 0.48, 0.4, 0.4), bbox_transform=fig_density.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = -1.95, -1.65, 1.3, 1.7  # Specify the limits of the zoomed-in area
...
# Create an inset axes object with specific dimensions and position it outside the main plot area
axins2_density = inset_axes(ax_density, width="100%", height="180%", loc='upper right', bbox_to_anchor=(1.05, 0.48, 0.4, 0.4), bbox_transform=fig_density.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 3.0, 3.2, 1.3, 1.7  # Specify the limits of the zoomed-in area
...
# Create an inset axes object with specific dimensions and position it outside the main plot area
axins3_density = inset_axes(ax_density, width="100%", height="180%", loc='upper right', bbox_to_anchor=(0.28, -0.48, 0.4, 0.4), bbox_transform=fig_density.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 3.15, 3.5, 0.89, 1.11  # Specify the limits of the zoomed-in area
