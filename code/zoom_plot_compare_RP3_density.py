#####################
#CFL 0.45 up to order 11
#100 elements
#####################
nametest="RP3"
file="SOLUTION_OCT_0000000.0120000.dat"
CFL_test=0.5 #0.95 #OK
...
x1, x2, y1, y2 = 0.02, 0.08, 0.95, 1.01  # Specify the limits of the zoomed-in area
...
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.3, 0.45, 0.525, 0.62  # Specify the limits of the zoomed-in area
...
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.78, 0.82, 0.95, 3.  # Specify the limits of the zoomed-in area
...
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.73, 0.79, 5.0, 6.5  # Specify the limits of the zoomed-in area
...
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.65, 0.75, 0.48, 2  # Specify the limits of the zoomed-in area
