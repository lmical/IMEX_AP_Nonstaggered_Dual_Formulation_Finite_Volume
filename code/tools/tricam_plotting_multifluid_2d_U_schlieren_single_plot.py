...
filename_test="SOLUTION_OCT_0000003.0000000.dat"
...
if "helium" in folder:
    filename_test="SOLUTION_OCT_0000001.5000000.dat" #helium
    name="helium"
    T=1.5
elif "r22" in folder:
    filename_test="SOLUTION_OCT_0000001.6000000.dat" #r22
    name="r22"
    T=1.6
else:
    print("Problem, not recongnized test")
    quit()
...
def plotting(folder_name, levels):
    ...
    fig.suptitle(filename_test)
    mydata_solution = np.loadtxt(folder_name + filename_test, skiprows=headerlines_in)
    ...
    plt.savefig(name+"_"+str(T)+".pdf", dpi=600, bbox_inches='tight')
    plt.show()
