    ...
    def plot_one_step(i):
        ...
        for indi in range(1, NX - 1):
            for indj in range(1, NY - 1):
                VORT[indi, indj] = (V[indi + 1, indj] - V[indi - 1, indj]) / (2 * dx) - (U[indi, indj + 1] - U[indi, indj - 1]) / (2 * dy)
