...
def plotting(folder_name, levels, output_file):
    ...
    # Choose writer based on the output format
    ...
    output_path = output_file + file_extension

    with writer.saving(fig, output_path, dpi=800):
        for i in range(nfiles_solution):
            ...
            # Write frame to video or GIF
            writer.grab_frame()

if __name__ == '__main__':
    output_file = "simulation_output"
    plotting(folder, 30, output_file)
