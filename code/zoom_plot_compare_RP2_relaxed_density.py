...
x1, x2, y1, y2 = 0.19, 0.26, 0.85, 1.01  # Specify the limits of the zoomed-in area
...
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.4, 0.6, 0.12, 0.23  # Specify the limits of the zoomed-in area
...
# Create an inset axes object with specific dimensions and position it outside the main plot area
axins3 = inset_axes(ax, width="80%", height="80%", loc='upper right', bbox_to_anchor=(0.95, 0.48, 0.4, 0.4), bbox_transform=fig.transFigure)
# Set the limits for the zoomed-in region
x1, x2, y1, y2 = 0.74, 0.81, 0.85, 1.01  # Specify the limits of the zoomed-in area
